...
<div class="form px-3">
  ...
  <select name="category" id="category" class="form-control @error('service') is-invalid @enderror">
...
@enderror
        ...
        <div class="mb-4">
       <label for="service" class="pb-2">service</label>
       <select name="category"id="service" name="service"class="form-control @error('service') is-invalid @enderror">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                      if(data){
                        ...
                        $('#service').append("<option value''>no service</option>")
