...
<div id="sidebar-menu">
    ...
    <ul class="metismenu list-unstyled" id="side-menu">
        ...
        <li>
            <a href="{{ route('manage_cash_withdrawal') }}">
                <i class="fa-solid fa-cash-register"></i>
                <span>ادارة السحب النقدي</span>
            </a>
        </li>

        <li>
            <a href="{{ route('ownerPercentage.index') }}">
                <i class="fa-solid fa-dollar-sign"></i>
                <span>نسبة عمولة المالك</span>
            </a>
        </li>
        ...
        <li>
            ...
            <ul class="sub-menu" aria-expanded="false">
                <li><a href="{{ route('public_requests') }}">الطلبات العامة</a></li>
            </ul>

            <ul class="sub-menu" aria-expanded="false">
                <li><a href="{{ route('private_requests') }}">الطلبات الخاصة</a></li>
            </ul>
        </li>
