<div id="userfinishedreservation{{ $request->id }}" class="modal offers fade" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" tabindex="-1">
        ...
        <div class="modal-content">
           ...
           <form action="{{route('user.reservation.compelete',$request->id)}}" action="GET">
                <div class="btn-contianer d-flex flex-column justify-content-center align-items-center my-3">
                    ...
                    <button class="btn-modal my-3 btn-model-primary border-0" type="submit">complete</button>
                </div>
            </form>
            </div>
        </div>
