        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="btn-contianer d-flex flex-lg-row flex-column-reverse justify-content-center align-items-center my-3  gap-2 gap-lg-0">
                    ...
                    <button class=" btn-accept  paybutton border-0 btn-modal rounded-pill mx-2"type="button" data-bs-toggle="modal" data-bs-target="#pay{{$request->id}}"   data-res='{{$request->id}}'>accept</button>
                </div>
            </div>
        </div>
    </div>
