<div class="modal offers fade" id="userreseravrtionwaitingwithcancel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" tabindex="-1">
    ...
    <i class="uil-comments-alt"  style="font-size:20px;"></i>
        ...
        <div class="d-flex justify-content-between">
          ...
          <div class="btn-contianer d-flex flex-column justify-content-center align-items-center my-3">
            <p class="craz-color fw-light" style="font-size: 14px">You can cancel your reservation before 48 hours from reserve date
            </p>
            <button class="btn-cormoz btn-modal border-0"type="button" data-bs-toggle="modal" data-bs-target="#surdeletereservation" >cancel</button>
