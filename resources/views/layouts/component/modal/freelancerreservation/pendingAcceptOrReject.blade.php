<div class="modal offers fade" id="feelancerReservationPendingAceptOrReject" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" tabindex="-1">
...
<a  href="#" data-bs-toggle="offcanvas" data-bs-target="#chat" aria-controls="offcanvasRight">
    <i class="uil-comments-alt"  style="font-size:20px;"></i>
          ...
          <div class="d-flex justify-content-between">
              ...
              <p class="fw-900 mb-0 text-black ">sara</p>
          </div>
          <div class="d-flex justify-content-between">
              <p class=" mb-0">Occation</p>
              <p class="fw-900 mb-0 text-black">wedding</p>
          </div>
          <div class="d-flex justify-content-between">
          ...
          <div class="d-flex justify-content-between">
              ...
              <div class="d-flex">
                ...
                <p class="fw-900 mb-0 text-black ">00:00 pm</p>
          ...
          <div class="d-flex justify-content-between">
            ...
            <p class="fw-900 mb-0 text-black"><i class="fa fa-location"></i> location</p>
        </div>
          </div>
         
          <div class="btn-contianer d-flex flex-row justify-content-center align-items-center my-3">
           
            <button class="btn btn-reject border-0 btn-modal rounded-pill mx-2"type="button" data-bs-toggle="modal" data-bs-target="#suredelete" >reject</button>
            <button class="btn btn-accept border-0 btn-modal rounded-pill mx-2"type="button" data-bs-toggle="modal" data-bs-target="#sendofferforreservation" >accept</button>
