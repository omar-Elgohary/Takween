<div class="modal offers fade" id="frelancerreservationinprogress" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" tabindex="-1">
    ...
    <i class="uil-comments-alt"  style="font-size:20px;"></i>
        ...
        <div class="d-flex justify-content-between">
          ...
          <div class="btn-contianer d-flex flex-column justify-content-center align-items-center my-3">
            ...
            <button class="btn-modal  my-3 btn-model-primary border-0"type="button"  >finish</button>
