<div class="modal offers fade" id="inprogressenddueprivate{{ $request->id }}" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" tabindex="-1">
                ...
                <div class="d-flex flex-column px-2 ">
                    <div class="file d-flex mb-2">
                        <div class="details d-flex ">
                            ...
                            <div class="info"><p class=" mb-0">Lorem ipsum dolor sit amet, consetetur</p>
                                <div class="size">521kB .word
                                </div>
                            </div>
                        </div>
                    </div>
