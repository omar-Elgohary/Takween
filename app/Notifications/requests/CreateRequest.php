...
class CreateRequest extends Notification
{
     ...
     public function __construct($user_create,$request,$type,$random_id)
    {
        ...
        $this->random_id=$random_id;
          ...
          $this->message_ar = "تم إنشاء طلب جديد رقم " . $this->random_id . " بواسطة " . User::find($user_create)->name;
        
            $this->message_en= "new request " .$this->random_id.' created  by '.User::find($user_create)->name ;
